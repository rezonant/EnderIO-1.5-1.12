  ...
  public GuiHyperCube(TileHyperCube te) {
    ...
    addToolTip(new GuiToolTip(new Rectangle(POWER_X, POWER_Y, POWER_WIDTH, POWER_HEIGHT), "") {
      ...
      protected void updateText() {
        text.clear();
        text.add(PowerDisplayUtil.formatPower(cube.storedEnergy) + " / "
            + PowerDisplayUtil.formatPower(cube.internalCapacitor.getMaxEnergyStored()) + " " + PowerDisplayUtil.abrevation());
      }
