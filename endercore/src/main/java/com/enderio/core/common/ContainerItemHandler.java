...
//  }
//
//  public ContainerItemHandler(@Nonnull Inventory playerInv, @Nonnull T owner, @Nullable Direction facing) {
//    this.owner = checkNotNull(owner);
//    this.inv = owner.getCapability(ForgeCapabilities.ITEM_HANDLER, facing).orElse(null);
...
//
//  @Override
//  public @Nonnull ItemStack transferStackInSlot(@Nonnull Player p_82846_1_, int p_82846_2_) {
