...
//
//public abstract class ContainerEnderCap<T extends IItemHandler, S extends BlockEntity> extends Container implements GhostSlot.IGhostSlotAware {
//
...
//  private final @Nonnull PlayerInvWrapper playerInv;
